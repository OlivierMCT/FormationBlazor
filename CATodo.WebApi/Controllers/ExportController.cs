...
using CATodo.WebApi.Controllers;
    ...
    public partial class ExportController : Controller {
        ...
        public FileStreamResult ToExcel() {
            ...
            using (var document = SpreadsheetDocument.Create(stream, SpreadsheetDocumentType.Workbook)) {
                ...
                foreach (var column in typeof(Todo).GetProperties()) {
                ...
                foreach (var item in _todoService.ListAllTodos()) {
                    var row = new Row();
                    ...
                    foreach (var column in typeof(Todo).GetProperties()) {
                        ...
                        var cell = new Cell();
                        var typeCode = column.PropertyType;

                        if (typeCode == typeof(DateTime)) {
                        ...
                        } else if (typeCode == typeof(int) || typeCode == typeof(double)) {
                            if (value != null) {
            ...
            result.FileDownloadName = "ExportTodos.xlsx";
